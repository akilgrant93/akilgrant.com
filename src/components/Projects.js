    ...
    <section id="projects" className="text-gray-400 w-full bg-gray-900 body-font">
      <div className="mx-auto text-center">
		...
		<ul onClick={handleEvent} className="header md:mb-2 lg:mb-10">
			...
			<li><img alt="A number of computer screens displaying the UI layout of the shoelala e-commerce platform" className="icon" src={require('../media/shoelala_01.png')} /></li>
